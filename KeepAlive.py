...
with open(path,'r') as file:
    ...
    mongoURL = "mongodb://"+configuracion["mongo"]["user"]+":"+urllib.parse.quote(configuracion["mongo"]["password"]).replace("/","\/")+"@"+configuracion["mongo"]["host"]+":"+str(configuracion["mongo"]["port"])+"/?authSource="+configuracion["mongo"]["database"]
