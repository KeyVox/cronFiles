...
with open(path,'r') as file:
    ...
    mongoURL = "mongodb://"+configuracion["mongo"]["user"]+":"+urllib3.quote(configuracion["mongo"]["password"])+"@"+configuracion["mongo"]["host"]+":"+str(configuracion["mongo"]["port"])+"/?authSource="+configuracion["mongo"]["database"]
